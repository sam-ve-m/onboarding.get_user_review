...
@pytest.mark.asyncio
@patch('func.src.services.user_review.UserRepository.find_one_by_unique_id', return_value=stub_user)
async def test_when_unique_id_valid_then_return_customer_registration_built(mock_find_one):
